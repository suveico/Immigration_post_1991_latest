...
output_file(filepath + "__1-B1.html")
...
show(column(
    Div(
        text="<h2>Immigration by top 10 nationalities<br/>in immigrants real number<br>period [1993-2018]</h2>"),
    Div(
        text=f"<h4 style='color:red'></h4>"),
    g
))


export_png(g, filename=filepath + "__1-B1.png")
